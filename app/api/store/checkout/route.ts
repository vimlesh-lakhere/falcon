...
export async function POST(req: NextRequest) {
  try {
    ...
    const { data: dbProducts, error: prodErr } = await supabase
      .from("products")
      .select("id, name, selling_price, purchase_price, current_stock, image_url, is_active, wholesale_price, wholesale_min_qty, mrp, price_basis, online_price, is_online, description, unit:units(id,name,conversion_factor)")
      .in("id", productIds)
      .eq("shop_id", shopId);
