...
ALTER TABLE IF EXISTS shops ADD COLUMN IF NOT EXISTS subscription_starts_at TIMESTAMPTZ;
ALTER TABLE IF EXISTS shops ADD COLUMN IF NOT EXISTS subscription_ends_at TIMESTAMPTZ;
ALTER TABLE IF EXISTS shops ADD COLUMN IF NOT EXISTS subscription_duration_months INT DEFAULT 1;
ALTER TABLE IF EXISTS shops ADD COLUMN IF NOT EXISTS subscription_amount NUMERIC DEFAULT 0;
